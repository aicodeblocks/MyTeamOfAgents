...
- Mansoor prefers daily briefings to open with `Good morning, Mansoor. Here's your <day-name> briefing.` followed immediately by the weather, then the rest of the current briefing format.
